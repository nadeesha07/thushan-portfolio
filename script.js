...
function initializeChatbot() {
    ...
    const botResponses = [
        ...
        { keywords: ['2sva'], response: "Here are the SVA links:<div class='chat-buttons'><a href='https://regal-maamoul-ad0fef.netlify.app/' target='_blank' class='chat-btn'><span class='chat-btn-icon purple'><i class='fas fa-globe'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Vehicle Manager</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a><a href='https://dainty-smakager-e32c30.netlify.app/' target='_blank' class='chat-btn'><span class='chat-btn-icon blue'><i class='fas fa-briefcase'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Job Management System</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a><a href='https://aquamarine-parfait-5afc72.netlify.app/' target='_blank' class='chat-btn'><span class='chat-btn-icon green'><i class='fas fa-link'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Petty Cash</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a><a href='https://soft-chimera-071eca.netlify.app/' target='_blank' class='chat-btn'><span class='chat-btn-icon orange'><i class='fas fa-money-bill-wave'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Other Expenses</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a><a href='https://remarkable-treacle-70a539.netlify.app/' target='_blank' class='chat-btn'><span class='chat-btn-icon red'><i class='fas fa-users'></i></span><span class='chat-btn-info'><span class='chat-btn-title'>2SVA Employee Dashboard</span><span class='chat-btn-desc'>Web application</span></span><i class='fas fa-arrow-right chat-btn-arrow'></i></a></div>" }
    ];
